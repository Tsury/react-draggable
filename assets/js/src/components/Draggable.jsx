...
class Draggable extends React.Component {
  ...
  render() {
    ...
    const classNameWhileDraggingProp = this.state.dragging ? classNameWhileDragging || '' : '';
  ...
  getNewPosition(pageX, pageY) {
    ...
    const newPos = {
      x: dragStartElementPos.x + window.devicePixelRatio * (1 / zoom) * (pageX - dragStartInputPos.x),
      y: dragStartElementPos.y + window.devicePixelRatio * (1 / zoom) * (pageY - dragStartInputPos.y),
    };
